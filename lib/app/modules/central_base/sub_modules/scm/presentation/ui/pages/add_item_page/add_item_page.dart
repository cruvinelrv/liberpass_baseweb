...
import '../../../cubits/item_page_cubit/item_page_cubit.dart';
...
class _AddItemPageState extends State<AddItemPage> {
  ...
  late final ItemPageCubit _itemPageCubit;
  ...
  void initState() {
    super.initState();
    _itemPageCubit = Modular.get<ItemPageCubit>();
    focus = FocusNode();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: BlocListener<ItemPageCubit, ItemPageStates>(
          bloc: _itemPageCubit,
          listener: (context, state) {
            if (state is ItemCostState) {
              _controllerCostPrice.text = _itemPageCubit.costPrice.toString();
              _controllerSalePrice.text = _itemPageCubit.salePrice.toString();
            }
          },
          child: Form(
            key: _formCadItemKey,
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField(
                              ...
                              validator: (value) {
                                if (value == null) {
                                  return 'Selecione o status do item';
                                }
                                return null;
                              },
                              decoration: const InputDecoration(
                              ...
                              items: EnumStatusItem.values
                                  ...
                                  .toList(),
                              onChanged: (value) {
                                _controllerStatus.text = value.toString();
                            ...
                            children: [
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  onEditingComplete: () {
                                    _itemPageCubit.calculateCostPrice(
                                        margin: _controllerMarginCost.text, purchase: _controllerPurchasePrice.text);
                              ...
                              const SizedBox(width: 8.0),
                              Expanded(
                                child: BlocBuilder<ItemPageCubit, ItemPageStates>(
                                  bloc: _itemPageCubit,
                                  builder: (context, state) {
                                    if (state is ItemCostState || state is ItemInitial) {
                                  ...
                                  builder: (context, state) {
                                    if (state is ItemCostState || state is ItemInitial) {
                                      return TextFormField(
                                        ...
                                        onEditingComplete: () {
                                          _itemPageCubit.calculateSalePrice(
                                              margin: _controllerMarginProfit.text, sale: _controllerCostPrice.text);
